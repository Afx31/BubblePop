...
class Balls: SKNode {
    ...
    init(image: SKSpriteNode) {
        ...
        //determine which side of the x acis the ball will spawn
        ...
        self.physicsBody = SKPhysicsBody(texture: SKTexture(imageNamed: "ball"),
                                         size: CGSize(width: image.size.width * 0.01, height: image.size.width * 0.01))
